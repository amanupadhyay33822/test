      ...
      <section id="footer">
        ...
        <div className="Services">
          ...
          <ul>
            <li>
              <span>
                <a href="#">ALS Ambulance</a>
              </span>
            </li>
            <li>
              <span>
                <a href="#">BLS Ambulance</a>
              </span>
            </li>
            <li>
              <span>
                <a href="#">PTS Ambulance</a>
              </span>
            </li>
            <li>
              <span>
                <a href="#">Mortality Ambulance</a>
              </span>
            </li>
          </ul>
        </div>
        <div className="contact">
          ...
          <ul>
            ...
            <li>
              <img className="contact-icon" src="images/Footer-images/Gmail.png" alt="gmail icon" />
              <span>
                <p>
            ...
            <li>
              ...
              <span>
                <p>
                  <a href="tel:+7505853812">7505853812  <br/></a>
